  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/[0.06] bg-background/80 backdrop-blur-2xl">
      <div className="mx-auto flex h-16 w-full max-w-[1600px] items-center gap-3 px-4 sm:px-6 lg:px-8">
        ...
        {/* ======================== SEARCH ======================== */}
        <div className="hidden min-w-0 max-w-[380px] flex-1 relative lg:flex">
        ...
        {/* ======================== NAVEGACIÓN ======================== */}
        <nav className="hidden shrink-0 items-center gap-1 whitespace-nowrap lg:flex">
          <Link
            href="/events"
        ...
        <div className="ml-auto hidden shrink-0 items-center gap-2 lg:flex">
          {isLoggedIn ? (
            <>
              <Link
                href="/dashboard"
                className="flex shrink-0 items-center gap-2 whitespace-nowrap rounded-xl px-3 py-2.5 text-sm font-medium text-muted transition-colors hover:bg-white/[0.03] hover:text-foreground"
              >
                <Ticket size={16} />
                Mis boletos
              </Link>
            ...
            <>
              <Link
                href="/login"
                className="shrink-0 whitespace-nowrap rounded-xl border border-white/[0.06] px-4 py-2.5 text-sm font-medium text-muted transition-colors hover:bg-white/[0.03] hover:text-foreground"
              >
                Iniciar Sesión
              </Link>
              <Link
                href="/register"
                className="shrink-0 whitespace-nowrap rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary/90"
              >
                Registrarse
              </Link>
            </>
